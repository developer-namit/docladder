...
class ProductEquipment extends Model
{
 ...
 {
  $query = "
  SELECT * FROM jobseeker_equipment 
  WHERE status = '0' 
  ";
...
function make_query_seeker($state, $country, $brand, $maximum, $minimum)
 {
  $query = "
  SELECT * FROM recruiter_equipment
  WHERE status = '0' 
  ";
...
function countall($state, $country, $brand,  $maximum, $minimum){
...
$total=0;
 ...
 $data_2 = $this->db->query($query_seeker)->getNumRows();
 $data_3 = $this->db->query($query_sell)->getNumRows();

if(!empty($data) || !empty($data_2) || !empty($data_3)){
    $total= $data+$data_2+$data_3;
}else{
    $total=0;
}
return $total;
 ...
 function count_all($state, $country, $brand,  $maximum, $minimum)
 {
    $query = $this->make_query($state, $country, $brand,  $maximum, $minimum);
    $query_seeker = $this->make_query_seeker($state, $country, $brand,  $maximum, $minimum);
    $query_sell = $this->make_query_sell($state, $country, $brand,  $maximum, $minimum);
...
$total=0;
 $data = $this->db->query($query)->getNumRows();
 $data_2 = $this->db->query($query)->getNumRows();
 $data_3 = $this->db->query($query)->getNumRows();
...
if(!empty($data) || !empty($data_2) || !empty($data_3)){
 ...
 function fetch_data($state, $country, $brand,  $maximum, $minimum)
 {
  ...
  $query_sell = $this->make_query_sell($state, $country, $brand,  $maximum, $minimum);
    ...
    $query_seeker.=' ORDER BY id desc ';
    
    $query_sell.=' ORDER BY id desc ';
  ...
  <div class="employers-grid text-center bg-white">
          ...
          <img src="'.base_url('/public/uploads/equipmentimages').'/'.$row['file_image'].'" alt="" class="img-responsive" >
          </div>
    <div class="employers-list-details">
    <div class="employers-list-info">
          <div class="employers-list-title">
          <h5 class="mb-0">    
          <a href="'.base_url('Productdetail').'/'.$row['id'].'">'. $row['product_name'] .'</a></h5>
          </div>
  ...
  <div class="employers-grid text-center bg-white">
    ...
    <div class="employers-list-info">
          <div class="employers-list-title">
          <h5 class="mb-0">    
          <a href="'.base_url('Productdetails').'/'.$row['id'].'">'. $row['product_name'] .'</a></h5>
          </div>
          <div class="employers-list-option">
          <ul class="list-unstyled">
          <li><i class="fas fa-rupee-sign pe-1"></i>'. $row['product_price'] .'</li>
  ...
  <div class="employers-grid text-center bg-white">
          <div class="employers-list-logo">
          <img src="'.base_url('/public/uploads/equipmentimages').'/'.$sells['file_image'].'" alt="" class="img-responsive" >
          </div>
    <div class="employers-list-details">
    <div class="employers-list-info">
          <div class="employers-list-title">
          <h5 class="mb-0">    
          <a href="'.base_url('Productsdetail').'/'.$sells['id'].'">'. $sells['product_name'] .'</a></h5>
          </div>
          <div class="employers-list-option">
          <ul class="list-unstyled">
