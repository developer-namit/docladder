                            ...
                            <div class="col-md-6">
                                <ul class="list-unstyled d-block mb-0">
                                     ...
                                     <li class="mb-5 pb-2 text-right">
                                        <a class="modify-search-btn" onclick=mymodifyadvance();><i class="fas fa-edit me-2"></i>Modify Search</a>
                                    </li>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-check-input checkbox" type="checkbox" value="<?php if(!empty($simple['id'])){ echo $simple['id']; }?>" id="checkboxid">
                                            <label class="form-check-label" for="flexCheckDefault"><span><?php if(!empty($simple['totaldays'])){ echo $simple['totaldays']; }?></span> Old <?php if(!empty($simple['payment'])){ echo '('.$simple['payment']; ?>) <span><i class="fas fa-check"></i></span><?php }?></label>
                                        </div>
                                        <a href="<?=base_url('/candidate/profile').'/'.$simple['id']; ?>" target="_blank">
                                            <h3><?php if(isset($simple['first_name']) && !empty($simple['first_name'])){ echo $simple['first_name']; }?></h3>
                                        </a>
                                        <ul class="candidate-details-items list-unstyled mb-0">
                                            ...
                                            <li>
                                                ...
                                                <span class="mx-2"><i class="fas fa-arrow-right"></i></span>
                                                <p class="mb-0"><?php if(isset($simple['preffered_location']) && !empty($simple['preffered_location'])){ echo $simple['preffered_location']; }?></p>
                                            </li>
...
advance View Equipment Details Modal Popup -->    
  <div class="modal  modal-right popup-modal show" id="ViewadvanceForm" tabindex="-1" role="dialog" aria-hidden="true">
                                        ...
                                        <div class="bg-white login-register justify-content-center">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12 select-border mb-2">
                                                    ...
                                                    <input type="text" name="key_skills" id="key_skills" placeholder="Enter Key Skills" value="<?php if(!empty($_GET['key_skills'])){ echo $_GET['key_skills'];}?>" class="form-control" value="">
                                                    </div>
                                               ...
                                               <option value="" selected="selected">Select Value</option>
                                                ...
                                                <div class="form-group col-md-12 select-border mb-3">
                                                    ...
                                                    <select class="form-control basic-select <?php if($validation->getError('designation')): ?>is-invalid<?php endif ?>" name="designation" id="skills" required>
                                            ...
                                            <?php if ($validation->getError('designation')): ?>
                                                ...
                                                <div class="form-group col-md-12 select-border mb-3">
                                                    ...
                                                    <select class="form-control basic-select <?php if($validation->getError('specialization')): ?>is-invalid<?php endif ?>" name="specialization" id="specializations" required> 
                                            </select>
                                                ...
                                                <div class="form-group col-md-6 select-border mb-3">
                                                    ...
                                                    <?php if(!empty($graduate['education'])){
                                                        foreach($graduate['education'] as $key=> $edu){
                                                            if(!empty($_GET['graduate'])&& $_GET['graduate']== $key){
                                                            ?> 
                                                    <option value="<?=$key;?>" selected="selected"><?=$edu;?></option>
                                                    <?php }else{?>
                                                ...
                                                <div class="form-group col-md-6 select-border mb-3">
                                                    ...
                                                    <?php if(!empty($graduate['postgarduate'])){
                                                        foreach($graduate['postgarduate'] as $key=> $pedu){
                                                             if(!empty($_GET['postgarduate'])&& $_GET['postgarduate']== $key){
                                                            ?>
                                                            
                                                        <option value="<?=$key;?>" selected="selected"><?=$pedu;?></option>
                                                         <?php }else{?>
                                                ...
                                                <div class="form-group col-md-12 select-border">
                                                    ...
                                                    <?php if(!empty($graduate['specialty'])){
                                                        foreach($graduate['specialty'] as $key=> $spc){
                                                             if(!empty($_GET['speciality'])&& $_GET['speciality']== $key){ ?>
                                                        <option value="<?=$key;?>" selected="selected"><?=$spc;?></option>
                                                         <?php }else{?>
