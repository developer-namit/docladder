                         ...
                         <div class="single-property-area">
                                ...
                                <?php }}?>
                                    <div class="tab-pane"  role="tabpane2" id="example2"
                                        ...
                                        <video id="myvideo" controls poster="/images/w3html5.gif">
                                        <source  src="<?php echo base_url('/public/uploads/spacevideo');?>/<?php if(!empty($space['file_video'])){ echo $space['file_video']; }?>" type="video/mp4"/>
                                        </video>
                                        </div>
                                </div>
