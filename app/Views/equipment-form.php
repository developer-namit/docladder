...
<section class="space-ptb-outer bg-light recruiter-job-posting" >
  <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-9">
                <form class="postjob-form" id="myform" method="post" action="<?php echo base_url('equipmentform');?>" enctype="multipart/form-data">
                    <!--general info-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12 select-border" id="dynamic_field">
                                              ...
                                              <div class="input-group choose-file" >
                                                  ...
                                                  <!--<input type="file" name="image" class="form-control" id="files" >-->
                                            ...
                                            <div class="form-group col-md-6 mb-3">
                                                <label>Contact Details <em class="text-danger">*</em></label>
                                                <input type="tel" class="form-control allow_numeric" name="contact_details" maxlength="10" value="<?php echo set_value('contact_details'); ?>">
                                            ...
                                            <div class="form-group col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control allow_numeric" name="contact" maxlength="10"  value="<?php echo set_value('contact'); ?>" >
                                            ...
                                            <div class="form-group col-md-12 select-border mb-3">
                                                ...
                                                <?php if(!empty($county)){foreach($county as $counties){?>
