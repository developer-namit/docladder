...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Send email to Recruiter</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">Send email to Recruiter</li>
                </ol>
            </div>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Send email to Recruiter</h4>
            </div><!-- end card header -->
                            ...
                            <table class="table table-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                <input name="emails[]" class="form-check-input checkIn" type="checkbox" value="<?= $user['email_address']; ?>" id="cardtableCheck<?= $key; ?>">
                                                <label class="form-check-label" for="cardtableCheck<?= $key; ?>"><?= $user['email_address']; ?></label>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php } ?>
...
<script>
    $(document).ready(function() {
        ...
        $( "#SendEmail" ).submit(function( event ) {
            ...
            $('.text-danger').html('');
            $.ajax({
                url: "<?= base_url().'/admin/recruiter/bulk_email' ?>",
                type: "POST",
