                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="bg-dark-primrary slider-border-bottom row justify-content-center">
                            <div class="row" id="counter-div" style="width: 812px;">
                                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-lg-0 mb-3">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="list-unstyled justify-content-center d-flex mb-0 align-items-center">
                                        <li class="me-4 me-lg-2 "><img class="img-fluid" src="<?php echo base_url();?>/public/assets/images/bg-icons/suitcase.png" alt=""></li>
                                        <li class="counter-text">
                  ...
                  <div class="col-lg-3 get-col">
                    <div class="recruiter-image-block">
                        ...
                        <div class="premium-job">
                            ...
                            <p><a href="home/findOurPremiumJobSeekers">Click Here</a></p>
                        </div>
                    </div>
                </div>
            </div>
