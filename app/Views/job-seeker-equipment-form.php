...
<section class="space-ptb-outer bg-light recruiter-job-posting" >
  ...
  <div class="row justify-content-center">
      <div class="col-lg-11">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <form class="postjob-form" id="myform" method="post" action="<?php echo base_url('EquipmentjobForm');?>" enctype="multipart/form-data">
                    <!--general info-->
                                    ...
                                    <div class="bg-white login-register justify-content-center">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12 select-border" >
                                              ...
                                              <div class="input-group choose-file d-block" id="dynamic_field">
                                            ...
                                            <div class="form-group col-md-12 select-border mb-3" id="dynamicfield">
                                              ...
                                              <div class="input-group choose-file">
                                                    <input type="file" name="video" class="form-control" id="file-upload-video" readonly="readonly" value="<?php echo set_value('type'); ?>" accept="video/*" multiple  />
                                            ...
                                            <div class="form-group col-md-6 mb-3">
                                                <label><?= esc($contact_details);?><em class="text-danger">*</em></label>
                                                <input type="text" class="form-control allownumeric" name="contact_details" maxlength="10" value="<?php echo set_value('contact_details'); ?>">
                                            ...
                                            <div class="form-group col-md-6 mb-3">
                                                ...
                                                <input type="text"   maxlength="11"  class="form-control allow_numeric" name="contact"   value="<?php echo set_value('contact'); ?>" >
...
<script>
$(document).ready(function(){
 $(".allownumeric").on("input", function(evt) {
   var self = $(this);
   self.val(self.val().replace(/\D/g, ""));
   if ((evt.which < 48 || evt.which > 57)) 
   {
