...
<html lang="en">
  <head>
    ...
    <title>Docladder- Job Seeker Equipment Update</title>
...
<section class="space-ptb-outer bg-light recruiter-job-posting" >
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-9 text-center mb-3"><h2 class="main-site-title sub-title-bg"><span>Equipment Form Update</span></h2></div>
        <div class="col-lg-9">
                    ...
                    <div class="bg-white login-register justify-content-center">
                      <div class="row">
                        <div class="form-group col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" value="ABC" placeholder="">
                        </div>
                        ...
                        <div class="form-group col-md-12 mb-3">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" placeholder="" value="10000">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6 select-border mb-3">
                            ...
                            <select class="form-control basic-select">
                                <option value="JL">Jalandhar</option>
                        ...
                        <div class="form-group col-md-12 mb-3">
                            ...
                            <textarea class="form-control" rows="2" maxlength="2000">Proin nunc nibh, adipiscing eu nisi id, ultrices suscipit augue. Sed rhoncus hendrerit lacus, et venenatis felis.</textarea>
                        </div>
                        <div class="form-group col-md-12 mb-3">
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" value="ABC, 123">
                        </div>
                        <div class="form-group col-md-6 mb-3">
                        ...
                        <div class="form-group col-md-12 select-border mb-3">
                            ...
                            <select class="form-control basic-select">
                              <option value="value 01" selected="selected" data-select2-id="45">Armenia</option>
                        ...
                        <div class="form-group col-md-12 mt-2 mb-2 mb-lg-3 text-center">
                            <input type="button" class="btn btn-secondary main-btn" value="Update">
                        </div>
                      </div>
                    </div>
                </div>
