...
<html lang="en">
  <head>
    ...
    <title>Docladder- Equipment Update</title>
                        ...
                        <div class="bg-white login-register justify-content-center">
                          <div class="row">
                            ...
                            <div class="form-group col-md-12 mb-3">
                                ...
                                <textarea class="form-control" rows="2" maxlength="2000">Test Description</textarea>
                            </div>
                            <div class="form-group col-md-12 mb-3">
                            ...
                            <div class="form-group col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" value="321456987">
                            </div>
                            <div class="form-group col-md-6 mb-3">
                            ...
                            <div class="form-group col-md-6 mb-3">
                                <label>Contact</label>
                                <input type="tel" class="form-control" value="123456">
                            </div>
                            <div class="form-group col-md-6 mb-3">
