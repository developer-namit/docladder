        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="footer-logo"><a class="navbar-brand" href="index.html">
                    <img class="img-fluid" src="<?php echo base_url();?>/public/assets/images/new-footer-logo.png" alt="logo"></a>
                </div>
              <div class="row">
                <div class="col-lg-4 col-md-6">
                  <div class="footer-link">
                    ...
                    <li><a href="#">Search Recruiter</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                  <p class="mb-0"> © 2022 <a href="index.html">Docladder</a>. ALL RIGHTS RESERVED </p>
                </div>
            </div>
        </div>
    </div>
...
Javascript -->
    ...
    <script src="<?php echo base_url();?>/public/assets/js/popper/popper.min.js"></script>
    <script src="<?php echo base_url();?>/public/assets/js/bootstrap/bootstrap.min.js"></script>
    
    <!-- Page JS Implementing Plugins (Remove the plugin script here if site does not use that feature)-->
    <script src="<?php echo base_url();?>/public/assets/js/owl-carousel/owl-carousel.min.js"></script>

    <!-- Page JS Implementing Plugins (Remove the plugin script here if site does not use that feature)-->
    <script src="<?php echo base_url();?>/public/assets/js/select2/select2.full.js"></script>
    <script src="<?php echo base_url();?>/public/assets/js/datetimepicker/moment.min.js"></script>
    <script src="<?php echo base_url();?>/public/assets/js/datetimepicker/datetimepicker.min.js"></script>
