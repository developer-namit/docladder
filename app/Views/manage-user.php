...
<html lang="en">
  <head>
    ...
    <title>Docladder- Manage Sub Users</title>
          ...
          <div class="row justify-content-center">
              <div class="col-lg-3">
                  <div class="dashboard_nav_item">
                    <ul class="nav nav-tabs d-flex" id="myTab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link" id="tab-01" data-bs-toggle="tab" href="#editProfile" role="tab" aria-controls="editProfile" aria-selected="false"><i class="login-icon fas fa-edit"></i> Edit Profile</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" id="tab-02" data-bs-toggle="tab" href="#manageSubUser" role="tab" aria-controls="manageSubUser" aria-selected="true"><i class="login-icon fas fa-users"></i>Manage Sub Users</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="tab-03" data-bs-toggle="tab" href="#changePassword" role="tab" aria-controls="changePassword" aria-selected="false"><i class="login-icon fas fa-key"></i>Change Password</a>
                      </li>
                    </ul>
                  </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade show" id="editProfile" role="tabpanel" aria-labelledby="tab-01">
                              ...
                              <div class="bg-white login-register justify-content-center">
                                <div class="row">
                                  ...
                                  <div class="form-group col-md-12 mt-2 mt-lg-3 mb-3 text-center">
                                      <input class="btn btn-secondary main-btn" type="button" value="Update">
                                  </div>
                                </div>
                              </div>
                          </div>
                  ...
                  <div class="tab-pane fade show active" id="manageSubUser" role="tabpanel" aria-labelledby="tab-02">
                    <form class="postjob-form">
                        <div class="box">
                            <div class="box-header">
                            ...
                            <div class="box-body">
                                <div class="bg-white login-register justify-content-center">
                                  <div class="row">
                                      ...
                                      <div class="form-group col-md-6 mb-3">
                                          <label class="form-label" for="password2">View Password</label>
                                          <input type="password" class="form-control">
                                      </div>
                                      <div class="form-group col-md-12 mt-2 mt-lg-3 mb-3 text-center">
                            ...
                            <div class="box-body">
                                <div class="bg-white login-register justify-content-center">
                                  <div class="row">
                                    ...
                                    <div class="form-group col-sm-6 mb-3">
                                        <div class="forget-pass-btn"><input class="" type="reset" value="Forget Password"></div>
                                    </div>
                                    <div class="form-group col-md-6 mb-3">
