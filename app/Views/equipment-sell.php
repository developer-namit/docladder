...
<section class="space-ptb-outer bg-light recruiter-job-posting" >
  <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-9 text-center mb-3"><h2 class="main-site-title sub-title-bg"><span>Equipment Form</span></h2></div>
            <div class="col-lg-9">
                <form class="postjob-form" id="myform" method="post" action="<?php echo base_url('Equipments/sell');?>" enctype="multipart/form-data">
                    <!--general info-->
                                    ...
                                    <div class="bg-white login-register justify-content-center">
                                        <div class="row">
                                            <div class="form-group col-md-12 mb-3">
                                                ...
                                                <input type="text" name="product_name" value="<?php echo set_value('product_name'); ?>" class="form-control"  placeholder="Enter a Title">
                                            ...
                                            <div class="form-group col-md-12 select-border" id="dynamic_field">
                                              ...
                                              <div class="input-group choose-file" >
                                                  <input type="file" name="image"  class="form-control" accept="image/*" id="file-upload" value="<?php echo set_value('image'); ?>" />
                                            ...
                                            <div class="form-group col-md-12 mb-3">
                                                <label>Product Brand Name<em class="text-danger">*</em></label>
                                                <div class="input-group">
                                                       <input type="text" name="brand"   id="brand"   value="<?php echo set_value('brand'); ?>" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-12 mb-3">
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" name="product_price" maxlength="15"  id="product_price"   value="<?php echo set_value('product_price'); ?>" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="form-group col-md-12 mb-3">
                                                <label>SKU<em class="text-danger">*</em></label>
                                                <div class="input-group">
                                                       <input type="text" name="sku"   id="sku"   value="<?php echo set_value('sku'); ?>" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6 select-border mb-3">
                                                ...
                                                <select class="form-control basic-select" id="state" name="state">
                                                <option value="" selected disabled>Select Your state--</option>
                                                <?php if($state >0){foreach($state as $states){?>
                                            ...
                                            <div class="form-group col-md-12 mb-3">
                                                ...
                                                <textarea class="form-control" rows="2" name="product_description" maxlength="2000" ><?php echo set_value('product_description'); ?></textarea>
                                            </div>
                                            <div class="form-group col-md-12 mb-3">
                                                <label>Year of Manufacturing</label>
                                                <input type="text" class="form-control" name="year_of_manufacturing" maxlength="4"  id="pin"    value="<?php echo set_value('year_of_manufacturing'); ?>">
                                            </div>
                                            <div class="form-group col-md-12 select-border mb-3" id="dynamicfield">
                                              <label>Product Video </label>
                                              <div class="input-group choose-file">
                                                    <input type="file" name="video" class="form-control" id="file-upload-video" readonly="readonly" accept="video/*"/>
                                                    <label for="file-upload-video"  name="video" class="input-group-text" id="file-upload-filename-video">Choose file </label>
                                            </div>
                                            <button type="button" name="video_name" id="addvideo" class="btn btn-secondary main-btn">Add Video</button>
                                            </div>
                                            <div class="form-group col-md-6 mb-3">
                                                <label>Contact Details</label>
                                                <input type="text" class="form-control <?php if($validation->getError('contact_details')): ?>is-invalid<?php endif ?> allow_numeric" name="contact_details" maxlength="10" value="<?php if(!empty($getform['contact_no'])){echo $getform['contact_no']; }else{ echo set_value('contact_details');} ?>">
                                            ...
                                            <div class="form-group col-md-6 mb-3">
                                                ...
                                                <input type="text"  class="form-control <?php if($validation->getError('concerned_person_name')): ?>is-invalid<?php endif ?> " name="concerned_person_name" value="<?php if(!empty($getform['first_name'])){echo $getform['first_name']; }else{ echo set_value('concerned_person_name');}?>">
                                            ...
                                            <div class="form-group col-md-6 mb-3">
                                                <label>Contact</label>
                                                <input type="text" class="form-control <?php if($validation->getError('contact')): ?>is-invalid<?php endif ?> allow_numeric" name="contact" maxlength="10"  value="<?php if(!empty($getform['contact_no'])){echo $getform['contact_no']; }else{ echo set_value('contact');} ?>" >
                                            ...
                                            <div class="form-group col-md-6 mb-3">
                                                ...
                                                <input type="email" class="form-control <?php if($validation->getError('e-mail_address')): ?>is-invalid<?php endif ?>" name="e-mail_address" value="<?php if(!empty($getform['email_id'])){echo $getform['email_id']; }else{ echo set_value('e-mail_address');} ?>" >
                                            ...
                                            <div class="form-group col-md-12 select-border mb-3">
                                                ...
                                                <select class="form-control basic-select" name='country'>
                                                  ...
                                                  <option value="" selected disabled>Select Your counties--</option>
                                                <?php if(!empty($country)){foreach($country as $countries){?>
                                            ...
                                            <div class="form-group col-md-12 mt-2 mb-2 mb-lg-3 text-center">
                                                <input class="btn btn-secondary main-btn" type="submit" id="submitdata" value="Submit">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
  $(document).ready(function () {
    ...
    <script>
      var inputD = document.getElementById( 'file-upload-video' );
        var infoAreaD = document.getElementById( 'file-upload-filename-video' );
