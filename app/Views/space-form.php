...
<section class="space-ptb-outer bg-light recruiter-job-posting" >
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-9">
                <form class="postjob-form filter_data" id="spaceform" action="<?php echo base_url('spaceform');?>" method="post" enctype="multipart/form-data">
                    <!--general info-->
                                    ...
                                    <div class="bg-white login-register justify-content-center">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12 mt-3 mb-2 mb-lg-3 text-center">
                                                <input class="btn btn-secondary main-btn" type="submit" value="Submit" ïd="formsubmit">
                                            </div>
                                        </div>
                                    </div>
                                </div>
