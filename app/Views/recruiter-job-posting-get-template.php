...
<html lang="en">
  <head>
    ...
    <title>Docladder- Recruiter Job Posting Get Template</title>
  ...
  <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center mb-3">
                <h2 class="main-site-title sub-title-bg"><span>Get Template</span></h2>
             </div>
                        ...
                        <form class="postjob-form mx-3">
                                ...
                                <div class="box-body">
                                    <div class="row bg-white login-register justify-content-center">
                                        <div class="form-group col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" value="Physician" placeholder="Enter a Title">
                                        </div>
                                        <div class="form-group col-md-12 select-border mb-2">
                                            <label>Key Skills<em class="text-danger">*</em></label>
                                            <select class="form-control basic-select" multiple="multiple" placeholder="">
                                        ...
                                        <div class="form-group col-md-6 select-border mb-3">
                                            ...
                                            <select class="form-control basic-select">
                                              <option value="value 01" selected="selected">0</option>
                                        ...
                                        <div class="form-group col-md-6 select-border mb-3">
                                            ...
                                            <select class="form-control basic-select">
                                              <option value="value 01" selected="selected">1 Year</option>
                                              <option value="value 02">6 Months</option>
                                              <option value="value 03">9 Months</option>
                                        ...
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                              ...
                                              <input type="text" class="form-control" value="3" placeholder="Min">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                              ...
                                              <input type="text" class="form-control" value="4.5" placeholder="Max">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4 select-border mb-3">
                                            ...
                                            <select class="form-control basic-select">
                                              <option value="value 01">Anatomy</option>
                                              ...
                                              <option value="value 03" selected>Physician </option>
                                        ...
                                        <div class="form-group col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control" rows="2">Urgent Opening For Consultant Physician</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <select class="form-control basic-select">
                                      <option value="value 01">B.A.M.S</option>
                                      <option value="value 02" selected>M.B.B.S</option>
                                    ...
                                    <select class="form-control basic-select">
                                      ...
                                      <option value="value 02">DGO</option>
                                    ...
                                    <select class="form-control basic-select">
                                      <option value="value 01">Not Required</option>
                                      <option value="value 02">Mch</option>
                                      <option value="value 03" selected>DM</option>
                    ...
                    <div class="col-lg-4" style="position: relative;">
                        <div class="get-template-field bg-white box-shadow mb-3">
                            ...
                            <div class="col-md-12 mb-2 mt-2">
                                <ul class="list-unstyled d-flex align-items-center justify-content-center mb-0 recruiter-btn">
                                    <li class="me-2">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="row align-items-center preview-title">
                ...
                <div class="col-lg-4">
                    <a href="#"><input class="btn btn-secondary main-btn" type="button" value="Apply Now"></a>
                </div>
            </div>
            <div class="row">
